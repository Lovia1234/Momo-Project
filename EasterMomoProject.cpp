...
int main() {
	...
	pin_out=false;
	while(true){
		cout<<"welcome to lovia mobile money service \n";
	    cout<<"\n";
		...
		if (pin_out==true){
			...
			cout<<"you have successfully withdrawn 500cedis from your wallet with a fee of 5 cedis ";
			cout<<" your remaining balance is 495 \n";
		}
		...
		if (pin_out==true){
			...
			cout<<"you have successfully sent an amount of "<<amount<<" to "<<receiver_num<<", your wallet balance is "<<total_amount-amount<<endl;
			cout<<"\n";
		}
	}
	else if(option=="5"){
